  ...
  <body>
    <div id="container">
    	<div id="header">
    		...
    		<c:if test="${!res }"></c:if>
    		]&nbsp;[<a href="${pageContext.request.contextPath }/user/user-regist.jsp">免费注册</a>]&nbsp;&nbsp;&nbsp;<a href="index.jsp">首页</a>&nbsp;|&nbsp;<a href="${pageContext.request.contextPath }/user/cart.jsp">购物车</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|&nbsp;<a href="#">帮助</a></div>
