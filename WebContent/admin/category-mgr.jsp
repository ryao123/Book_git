    	...
    	<div id="main">
			<div class="section-left">
				...
				<table class="table" cellspacing="0">
			    	...
			    	<tr>
			    		<td>${c.category }</td>
			    		<td><a href="${pageContext.request.contextPath}/CategoryController?op=deleteCate&id=${c.id}">删除</a></td>
			    	</tr>			    
			    	</c:forEach>			    
			    </table>
			</div>
			<div class="section-right">
				<h2>添加分类信息</h2>
				<form action="${pageContext.request.contextPath}/CategoryController?op=addCate" method="post">
					<p>分类名称：
